#table(
    ...
    [SHIFTER_OP], [Shifter], [ShifterOp()], [ShifterOp.sll()],
    [SHIFTER_SRC2], [Shifter], [ShifterSrc2()], [ShifterSrc2.rj()],
    [SHIFTER_OUT], [Shifter], [Bits(32 bits)], [],
    [WRITE_AT_SHIFTER], [Shifter], [Bool()], [False],
)
