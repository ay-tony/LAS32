...
// Git hash  : 115c88e6d4d9b86c9c79692e0a37a3196a8ff7c7
...
module MyTopLevel (
  ...
  reg                 _zz_execute_haltRequest_MyTopLevel_l189;
  ...
  reg                 _zz_execute_haltRequest_MyTopLevel_l172;
  ...
  wire                decode_down_BYPASS_EXECUTE_ENABLE;
  ...
  always @(*) begin
    _zz_execute_haltRequest_MyTopLevel_l189 = 1'b0;
    if(when_MyTopLevel_l176) begin
      if(when_MyTopLevel_l185) begin
        if(!memory_down_BYPASS_MEMORY_ENABLE) begin
          _zz_execute_haltRequest_MyTopLevel_l189 = 1'b1;
        end
      end
    end
  end
  ...
  always @(*) begin
    _zz_execute_haltRequest_MyTopLevel_l172 = 1'b0;
    if(when_MyTopLevel_l159) begin
      if(when_MyTopLevel_l168) begin
        if(!memory_down_BYPASS_MEMORY_ENABLE) begin
          _zz_execute_haltRequest_MyTopLevel_l172 = 1'b1;
        end
      end
    end
  end
  ...
  assign decode_down_BYPASS_EXECUTE_ENABLE = 1'b0;
  always @(*) begin
  ...
  assign when_MyTopLevel_l138 = (execute_down_ALU_OP == AluOp_add);
  always @(*) begin
    if(when_MyTopLevel_l138) begin
      execute_down_ALU_OUT = _zz_execute_down_ALU_OUT;
    end else begin
      if(when_MyTopLevel_l140) begin
  ...
  assign when_MyTopLevel_l140 = (execute_down_ALU_OP == AluOp_sub);
  assign when_MyTopLevel_l146 = 1'b1;
  assign when_MyTopLevel_l152 = (write_down_REGFILE_WRITE_ENABLE && (write_down_REGFILE_WRITE_ADDR != 5'h00));
  assign when_MyTopLevel_l159 = (execute_down_REGFILE_ADDR1 != 5'h00);
  assign when_MyTopLevel_l161 = (execute_down_REGFILE_ADDR1 == write_down_REGFILE_WRITE_ADDR);
  assign execute_haltRequest_MyTopLevel_l165 = _zz_execute_haltRequest_MyTopLevel_l165;
  assign when_MyTopLevel_l168 = (execute_down_REGFILE_ADDR1 == memory_down_REGFILE_WRITE_ADDR);
  assign execute_haltRequest_MyTopLevel_l172 = _zz_execute_haltRequest_MyTopLevel_l172;
  assign when_MyTopLevel_l176 = (execute_down_REGFILE_ADDR2 != 5'h00);
  assign when_MyTopLevel_l178 = (execute_down_REGFILE_ADDR2 == write_down_REGFILE_WRITE_ADDR);
  assign execute_haltRequest_MyTopLevel_l182 = _zz_execute_haltRequest_MyTopLevel_l182;
  assign when_MyTopLevel_l185 = (execute_down_REGFILE_ADDR2 == memory_down_REGFILE_WRITE_ADDR);
  assign execute_haltRequest_MyTopLevel_l189 = _zz_execute_haltRequest_MyTopLevel_l189;
  ...
  assign when_CtrlLink_l151 = (|{execute_haltRequest_MyTopLevel_l189,{execute_haltRequest_MyTopLevel_l182,{execute_haltRequest_MyTopLevel_l172,execute_haltRequest_MyTopLevel_l165}}});
