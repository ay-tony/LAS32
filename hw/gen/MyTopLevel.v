...
// Git hash  : 6f0b0e250797acbc9491384d96a1e788da9af52c
...
module MyTopLevel (
  ...
  reg                 _zz_execute_haltRequest_MyTopLevel_l192;
  reg                 _zz_execute_haltRequest_MyTopLevel_l185;
  ...
  reg                 _zz_execute_haltRequest_MyTopLevel_l168;
  ...
  wire                decoder_IS_ORI;
  wire       [31:0]   alu_in2;
  wire                when_MyTopLevel_l141;
  wire                when_MyTopLevel_l143;
  wire                when_MyTopLevel_l149;
  wire                when_MyTopLevel_l155;
  wire                when_MyTopLevel_l162;
  wire                when_MyTopLevel_l164;
  wire                execute_haltRequest_MyTopLevel_l168;
  wire                when_MyTopLevel_l171;
  wire                execute_haltRequest_MyTopLevel_l175;
  wire                when_MyTopLevel_l179;
  wire                when_MyTopLevel_l181;
  wire                execute_haltRequest_MyTopLevel_l185;
  wire                when_MyTopLevel_l188;
  wire                execute_haltRequest_MyTopLevel_l192;
  ...
  always @(*) begin
    _zz_execute_haltRequest_MyTopLevel_l192 = 1'b0;
    if(when_MyTopLevel_l179) begin
      if(when_MyTopLevel_l188) begin
        if(!memory_down_BYPASS_MEMORY_ENABLE) begin
          _zz_execute_haltRequest_MyTopLevel_l192 = 1'b1;
        end
      end
    end
  end
  ...
  always @(*) begin
    _zz_execute_haltRequest_MyTopLevel_l185 = 1'b0;
    if(when_MyTopLevel_l179) begin
      if(when_MyTopLevel_l181) begin
        if(!memory_down_BYPASS_WRITE_ENABLE) begin
          _zz_execute_haltRequest_MyTopLevel_l185 = 1'b1;
        end
      end
    end
  end
  ...
  always @(*) begin
    _zz_execute_haltRequest_MyTopLevel_l168 = 1'b0;
    if(when_MyTopLevel_l162) begin
      if(when_MyTopLevel_l164) begin
        if(!memory_down_BYPASS_WRITE_ENABLE) begin
          _zz_execute_haltRequest_MyTopLevel_l168 = 1'b1;
        end
      end
    end
  end
  ...
  assign when_MyTopLevel_l141 = (execute_down_ALU_OP == AluOp_add);
  always @(*) begin
    if(when_MyTopLevel_l141) begin
      execute_down_ALU_OUT = _zz_execute_down_ALU_OUT;
    end else begin
      if(when_MyTopLevel_l143) begin
  ...
  assign when_MyTopLevel_l143 = (execute_down_ALU_OP == AluOp_sub);
  assign when_MyTopLevel_l149 = 1'b1;
  assign when_MyTopLevel_l155 = (write_down_REGFILE_WRITE_ENABLE && (write_down_REGFILE_WRITE_ADDR != 5'h00));
  assign when_MyTopLevel_l162 = (execute_down_REGFILE_ADDR1 != 5'h00);
  assign when_MyTopLevel_l164 = (execute_down_REGFILE_ADDR1 == write_down_REGFILE_WRITE_ADDR);
  assign execute_haltRequest_MyTopLevel_l168 = _zz_execute_haltRequest_MyTopLevel_l168;
  assign when_MyTopLevel_l171 = (execute_down_REGFILE_ADDR1 == memory_down_REGFILE_WRITE_ADDR);
  assign execute_haltRequest_MyTopLevel_l175 = _zz_execute_haltRequest_MyTopLevel_l175;
  assign when_MyTopLevel_l179 = (execute_down_REGFILE_ADDR2 != 5'h00);
  assign when_MyTopLevel_l181 = (execute_down_REGFILE_ADDR2 == write_down_REGFILE_WRITE_ADDR);
  assign execute_haltRequest_MyTopLevel_l185 = _zz_execute_haltRequest_MyTopLevel_l185;
  assign when_MyTopLevel_l188 = (execute_down_REGFILE_ADDR2 == memory_down_REGFILE_WRITE_ADDR);
  assign execute_haltRequest_MyTopLevel_l192 = _zz_execute_haltRequest_MyTopLevel_l192;
  ...
  assign when_CtrlLink_l151 = (|{execute_haltRequest_MyTopLevel_l192,{execute_haltRequest_MyTopLevel_l185,{execute_haltRequest_MyTopLevel_l175,execute_haltRequest_MyTopLevel_l168}}});
